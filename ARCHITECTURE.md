...
- `tools/schematic_report.cpp` — `scons schematic_report`: decodes a block file off disk and prints its layout, dimensions, fill, bounding box and full block-state palette with counts
