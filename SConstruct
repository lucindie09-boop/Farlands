...
greedy_prog = greedy_env.Program("bin/greedy_measure", ["tools/greedy_measure.cpp"] + shared_objects + ["src/core/chunk_data.cpp"])
...
mem_env.Append(LIBS=[])
mem_prog = mem_env.Program("bin/memory_estimate", ["tools/memory_estimate.cpp"] + shared_objects + ["src/core/chunk_data.cpp"])
...
repro_prog = repro_env.Program("bin/repro_stride2", ["tools/repro_stride2.cpp"] + shared_objects + ["src/core/chunk_data.cpp"])
