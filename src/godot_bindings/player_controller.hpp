...
public:
    ...
    // vanilla's thirdPersonView). The bool overloads stay for compatibility.
    ...
    // Block-targeting ray — vanilla's eye-ray trace: the player's eye
...
private:
    ...
    // body-yaw): the body eases toward the travel direction while the
