...
var _arm_position_y: float = -0.03  # Adjusted for visibility (vanilla value -0.85 is too low)
var _arm_position_z: float = -0.50  # Adjusted for visibility (vanilla value 0.75 may be wrong direction)
...
# vanilla exact values from the first-person renderer
const MC_ROT_X := 64.0
const MC_ROT_Y := 54.0
const MC_ROT_Z := -62.0
const MC_POS_X := 0.25
